...
| **平均單回合獎勵分** | **-371.9 分** | 📈 正向累積 | 獎勵函數（目標推進分、通門大獎）大幅壓過碰撞扣分 |
| **平均存活步數** | **63.6 步** | ⏱️ 續航拉長 | 機體在狹窄空間中平均持續穩定自主巡航時間顯著拉長 |
